package com.example.ovenbakinggame;
...
public class MainActivity extends AppCompatActivity {
    ...
    public Integer timer_Count = 30; //미션 시간
            ...
            public void onClick(View v) {
                ...
                if (maxValue == nowValue) { //온도 바 최대값 = 현재값
                    ...
                    if (nowValue < 30) { //온도가 너무 낮으면 -1점
                        success_count--;
                        Toast.makeText(MainActivity.this, "반죽이 충분히 익지 않고 있어요!", Toast.LENGTH_SHORT).show();
                    ...
                    if (nowValue > 70) { //너무 높으면 -1점
                        success_count--;
                        Toast.makeText(MainActivity.this, "반죽이 탈 것 같아요!", Toast.LENGTH_SHORT).show();
